      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">
            Insights, tips, and guides to help you navigate your educational journey abroad. Stay updated with the
            latest trends and opportunities in international education.
          </p>
        </motion.div>
      </div>
    </section>
